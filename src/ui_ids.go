...
const (
	...
	EventDependencyRefresh = "dependency.refresh"
	...
	EventFileRenameInput     = "file.rename.input"
	...
	EventFilePaste           = "file.paste"
	EventFileClipboardClear  = "file.clipboard.clear"
	EventFileUpload          = "file.upload"
	EventFileDownload        = "file.download"
	EventFilePreviewLoad     = "file.preview.load"
