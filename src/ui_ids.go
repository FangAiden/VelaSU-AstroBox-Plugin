...
const (
	...
	EventTerminalAddFavorite       = "terminal.favorite.add"
	EventTerminalHistoryRunPrefix  = "terminal.history.run:"
	EventTerminalFavoriteRunPrefix = "terminal.favorite.run:"
	EventTerminalFavoriteDelPrefix = "terminal.favorite.delete:"
